This repository contains Python code for beginner-friendly Financial Data Analysis. 
It works with two CSV files: 
- One with company names, weights in the portfolio, and stock prices.  
- Another with financial performance data, including Net Income and other key metrics.  

The code automatically:  
- Analyzes portfolio composition.  
- Identifies top companies by weight and profit.  
- Highlights companies with losses.  
- Calculates a risk score based on weighted losses.  
